...
The completed Qwen3.5-2B Stage A/B/C training and `dev119` evaluation are
summarized in the
[2026-09-16 SFT curriculum report](research/2026-09-16-qwen35-2b-sft-curriculum-report.md).
The report also records the checkpoint decision, the observed long-trajectory
filtering, the current SFT/GRPO task-ID overlap, and the recommended GRPO
execution gates.
